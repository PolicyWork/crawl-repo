...
public class CrawlerWithHtmlUnitAndroid {

	public static void main(String[] args) throws InterruptedException,	IOException {

		BufferedReader readHandle;

		File file = new File("/home/manish/workspace/crawl-repo/CrawlerOutputAndroidJava.txt"); //We write into this file

		try {
			
			readHandle = new BufferedReader(new FileReader("/home/manish/workspace/crawl-repo/AndroidPolicyKeywords.txt"));  //Input file containing keywords
			...
			while ((keywordLine = readHandle.readLine()) != null) {
				...
				try {
					...
					String lang="java"; //Changed to xml to search for manifest file changes
...
//											gotMatchingText = true;
						...
						try{
							...
							System.out.println("NEXT PAGE URL VALUE:"+nextPageUrl);
							e.printStackTrace();
