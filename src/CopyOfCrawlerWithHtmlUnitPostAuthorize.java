...
public class CopyOfCrawlerWithHtmlUnitPostAuthorize {

	public static void main(String[] args) throws InterruptedException,	IOException {

		BufferedReader readHandle;

		File file = new File("/home/manish/workspace/crawl-repo/CrawlerOutputPostAuthorize.txt"); //We write into this file

		try {
			
			readHandle = new BufferedReader(new FileReader("/home/manish/workspace/crawl-repo/PostAuthorizeKeyword.txt"));  //Input file containing keywords
